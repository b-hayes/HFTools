...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $answersObservation->observation_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $answersObservation->observation_id)]
            )
        ?></li>
...
<div class="answersObservations form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Answers Observation') ?></legend>
        <?php
        ?>
    </fieldset>

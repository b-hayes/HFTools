    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="actions">
                ...
                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Clients', 'action' => 'delete', $clients->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $clients->id)]) ?>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="actions">
                ...
                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Roles', 'action' => 'delete', $roles->id],

        ...
        <div id="url-rewriting-warning" class="alert url-rewriting">
            <ul>
                <li class="bullet problem">
                    ...
                    1) <a target="_blank" href="http://book.cakephp.org/3.0/en/installation.html#url-rewriting">Help me
                    configure it</a><br/>
                    2) <a target="_blank"
...
<div class="row">
    <div class="columns large-6">
        ...
        <ul>
            ...
            <?php else: ?>
            <li class="bullet problem">Your version of PHP is too low. You need PHP 5.5.9 or higher to use CakePHP
    ...
    <div class="columns large-6">
        ...
        <ul>
            ...
            <li class="bullet success">The <em><?= $settings['className'] ?>Engine</em> is being used for core caching.
                To change the config edit config/app.php
            </li>
            <?php else: ?>
...
<div class="row">
    <div class="columns large-12 text-center">
        ...
        <p>
            CakePHP is a rapid development framework for PHP which uses commonly known design patterns like Front
            Controller and MVC.<br/>
            Our primary goal is to provide a structured framework that enables PHP users at all levels to rapidly
            develop robust web applications, without any loss to flexibility.
        </p>
    </div>
    <hr/>
</div>
